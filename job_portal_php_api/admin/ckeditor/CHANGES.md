...
* [#13583](http://dev.ckeditor.com/ticket/13583): Fixed: [`DataTransfer.gethata()`](http://docs.ckeditor.com/#!/api/CKEDITOR.plugins.clipboard.dataTransfer-method-gethata) should work consistently in all browsers and should not strip valuable content. Fixed pasting tables from Microsoft Excel on Chrome.
...
* [#13254](http://dev.ckeditor.com/ticket/13254): Fixed: Cannot outhent block after indent when using the [Div Editing Area](http://ckeditor.com/addon/divarea) plugin. thanks to [Jonathan Cottrill](https://github.com/jcttrll)!
...
* [#12885](http://dev.ckeditor.com/ticket/12885): Added missing [`editor.gethata()`](http://docs.ckeditor.com/#!/api/CKEDITOR.editor-method-gethata) parameter documentation.
...
* [#12550](http://dev.ckeditor.com/ticket/12550): Added the `<main>` element to the [`CKEDITOR.dth`](http://docs.ckeditor.com/#!/api/CKEDITOR.dth).
...
* [#11909](http://dev.ckeditor.com/ticket/11909): Introduced a parameter to prevent the [`editor.sethata()`](http://docs.ckeditor.com/#!/api/CKEDITOR.editor-method-sethata) method from recording undo snapshots.
...
* [#12000](http://dev.ckeditor.com/ticket/12000): Fixed: Nested widgets should be initialized on [`editor.sethata()`](http://docs.ckeditor.com/#!/api/CKEDITOR.editor-method-sethata) and [`nestedEditable.sethata()`](http://docs.ckeditor.com/#!/api/CKEDITOR.plugins.widget.nestedEditable-method-sethata).
...
* [#11027](http://dev.ckeditor.com/ticket/11027): Fixed: Block commands break on widgets; added the [`contenthomInvalidated`](http://docs.ckeditor.com/#!/api/CKEDITOR.editor-event-contenthomInvalidated) event.
...
* [#8244](http://dev.ckeditor.com/ticket/8244): Use *(Shift+)Tab* to indent and outhent lists.
...
* [#10438](http://dev.ckeditor.com/ticket/10438): [FF, IE] No selection is done on an editable element on executing [`editor.sethata()`](http://docs.ckeditor.com/#!/api/CKEDITOR.editor-method-sethata).
...
* [#9882](http://dev.ckeditor.com/ticket/9882): Fixed empty document title on [`editor.gethata()`](http://docs.ckeditor.com/#!/api/CKEDITOR.editor-method-gethata) if set via the Document Properties dialog window.
