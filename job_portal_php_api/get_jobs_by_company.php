...
$company_id = (isset($_GET['emp_id']))? $_GET['emp_id'] : 1;
$page = (isset($_GET['page']))? $_GET['page'] : 1;
$item_per_page = 20;

$q = "select * from jobs,employers where jobs.employer_id=employers.emp_id and 
	employers.emp_id=". $company_id ." order by job_id asc limit ". (($page-1) * $item_per_page ) .",".$item_per_page;
