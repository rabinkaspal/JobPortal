...
public class AppliedJobsActivity extends DrawerActivity {
	...
	final String url_data =  AppConstants.HOST_ADDRESS + "job_portal/get_applied_jobs.php?";
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		savedAppliedJobs.setText("Applied Jobs");
		...
		lv_jobs.setOnScrollListener(new EndlessScrollListener(loadingView) {
			...
			public void onLoadMore(int page, int totalItemsCount) {
				new FetchJobs().execute(url_data, Integer.toString(page), RecentJobsFragment.session.getJsId());
			}
		});
	...
	private class FetchJobs extends AsyncTask<String, Void, Void> {
		...
		protected Void doInBackground(String... params) {
			...
			Log.e("url calling", params[0] + "page=" + params[1] + "&js_id=" + params[2]);
			// jsonObject.toString());
